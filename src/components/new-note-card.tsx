...
export function NewNotecard({ onNoteCreated }: NewNotecardProps) {
  ...
  function handleStartRecording() {
    const isSpeechRecognitiononAPIAvailable = "SpeechRecognition" in window || "webkitSpeechRecognition" in window

    if (!isSpeechRecognitiononAPIAvailable) {
          ...
          <form className="flex-1 flex flex-col gap-3">
            <div className="flex flex-1 flex-col gap-3 p-5 ">
              ...
              {shouldShowOnboarding ? (
                ...
                <textarea
                  autoFocus
                  className="text-sm leading-6 text-slate-400 bg-transparent outline-none resize-none flex-1 w-full h-48"
